...
- `bypass_cloudinary` (optional boolean, default: `False`): Serve the url as-is instead of proxying through Cloudinary (e.g. for animated images, since Cloudinary truncates animations it transforms on the fly to 100 frames)
